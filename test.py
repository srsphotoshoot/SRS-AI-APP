...
if not GEMINI_API_KEY:
    st.error("⚠️ Google API key not found in .env file")
...
The output must look like a professional fashion catalog photo with the model wearing THIS EXACT lehenga design."""
